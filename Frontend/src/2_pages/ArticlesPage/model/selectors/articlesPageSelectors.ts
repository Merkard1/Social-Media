...
export const [useArticlesPageSort, getArticlesPageSort] = buildSelector((state: StateSchema) => state.articlesPage?.sort ?? "createdAt");
...
export const [useArticlesPageType, getArticlesPageType] = buildSelector((state: StateSchema) => state.articlesPage?.type ?? "ALL");
